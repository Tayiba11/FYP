          ...
          child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => AlphabetsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => FruitsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => vegetablesScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => animalsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => colorsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child:Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => peopleScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => expressionsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => professionsScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => vehiclesScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => weatherScreen(), // Navigate to AlphabetsScreen
                  ),
                );
              },
                  child: Container(
                  ...
                  // Add more CardBoxWithImage widgets as needed
                ],
              ),
            ),
          ),
